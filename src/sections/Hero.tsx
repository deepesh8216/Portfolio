  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className='absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]'>
        ...
        <HeroOrbit size={520} rotation={-41}  shouldOrbit orbitDuration='34s' shouldSpin spinDuration='8s'>
        ...
        <HeroOrbit size={650} rotation={-5}  shouldOrbit orbitDuration='42s' shouldSpin spinDuration='8s'>
      ...
      <div className='container'>
        ...
        <div className='max-w-lg mx-auto'>
          ...
          Hi, I'm Deepesh  Crafting Exceptional User Experiences</h1>
          <p className='mt-4 text-center text-white/60 md:text-lg'>
            I specialize in transforming designs into functional,
            heigh-performing web applications. Lets discuss your next project.
          </p>
        </div>
